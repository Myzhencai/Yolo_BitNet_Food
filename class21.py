...
def load_modelonnx(model_path, device='cpu'):
    model = YOLO(model_path)  # 自动识别为 ONNX 模型
...
if __name__ == "__main__":
    # cfg_model_path = 'models/best908.pt'        # 模型路径
    cfg_model_path = 'models/best908.onnx'        # 模型路径
    # cfg_model_path = 'models/best908_int8.onnx'        # 模型路径
    # cfg_model_path = 'models/best908_int8static.onnx'        # 模型路径
